...
<head runat="server">
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="/sevi/public/assets/img/favicons/apple-touch-icon.png"/>
    <link rel="icon" type="image/png" sizes="32x32" href="/sevi/public/assets/img/favicons/favicon-32x32.png"/>
    <link rel="icon" type="image/png" sizes="16x16" href="/sevi/public/assets/img/favicons/favicon-16x16.png"/>
    <link rel="shortcut icon" type="image/x-icon" href="/sevi/public/assets/img/favicons/favicon.ico"/>
    <link rel="manifest" href="/sevi/public/assets/img/favicons/manifest.json"/>
    <meta name="msapplication-TileImage" content="/sevi/public/assets/img/favicons/mstile-150x150.png"/>
    <meta name="theme-color" content="#ffffff"/>
    <link href="/sevi/public/assets/css/theme.css" rel="stylesheet" />
</head>
<body>
    <form id="form1" runat="server">
        <div style="background-color:#ff6a00; color:#ff6a00">
        </div>
    </form>
    <!-- ===============================================-->
    <!--    Main Content-->
    ...
    <main class="main" id="top">
      ...
      <section class="py-0" id="home">
        <div class="bg-holder d-none d-md-block" style="background-image:url(sevi/public/assets/img/illustrations/hero-section.png);background-position:right bottom;background-size:contain;">
        </div>
        <!--/.bg-holder-->

        <div class="bg-holder d-block d-md-none" style="background-image:url(sevi/public/assets/img/illustrations/hero-bg.png);background-position:right top;background-size:contain;">
        </div>
        <!--/.bg-holder-->
      ...
      <section id="libraries">
        <div class="bg-holder" style="background-image:url(sevi/public/assets/img/illustrations/libraries-bg.png);background-position:left bottom;background-size:contain;">
        </div>
        <!--/.bg-holder-->

        <div class="container">
          <div class="row g-xl-0 align-items-center">
            <div class="col-md-5 col-lg-7 text-xl-center"><img class="img-fluid mb-5 mb-md-0" src="sevi/public/assets/img/illustrations/our-libraries.png" width="620" alt="" /></div>
            <div class="col-md-7 col-lg-4 text-center text-md-start offset-lg-1 offset-xxl-0">
              <h1 class="fw-semi-bold text-warning">Our <span class="text-1100">libraries</span></h1>
              ...
              <div class="py-3">
                <button class="btn btn-lg btn-primary rounded-pill font-base" type="submit">Learn More </button>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="col-lg-9">
              <div class="accordion" id="accordionExample">
                ...
                <div class="accordion-item mb-5 border border-x-0 border-bottom-0 border-200">
                  ...
                  <div class="accordion-collapse collapse shadow-lg" id="collapse2" aria-labelledby="heading2" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      <div class="row justify-content-center-center">
                        <div class="col-12 col-sm-2"><img class="img-fluid d-block mx-auto mx-sm-0" src="assets/img/gallery/two-cities.jpg" width="130" alt="..." /></div>
                        <div class="col-12 col-sm-9 mt-4 mt-sm-0 d-sm-block d-flex flex-column">
                          <ul>
                            <li class="fw-semi-bold text-black">Copies Sold: 150 million</li>
                          </ul>
                ...
                <div class="accordion-item mb-5 border border-x-0 border-bottom-0 border-200">
                  ...
                  <div class="accordion-collapse collapse shadow-lg" id="collapse3" aria-labelledby="heading3" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      <div class="row justify-content-center-center">
                        <div class="col-12 col-sm-2"><img class="img-fluid d-block mx-auto mx-sm-0" src="assets/img/gallery/little-princess.jpg" width="130" alt="..." /></div>
                        <div class="col-12 col-sm-9 mt-4 mt-sm-0 d-sm-block d-flex flex-column">
                          <ul>
                            <li class="fw-semi-bold text-black">Copies Sold: 150 million</li>
                          </ul>
                ...
                <div class="accordion-item mb-5 border border-x-0 border-bottom-0 border-200">
                  ...
                  <div class="accordion-collapse collapse shadow-lg" id="collapse4" aria-labelledby="heading4" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      <div class="row justify-content-center-center">
                        <div class="col-12 col-sm-2"><img class="img-fluid d-block mx-auto mx-sm-0" src="assets/img/gallery/hobbit.jpg" width="130" alt="..." /></div>
                        <div class="col-12 col-sm-9 mt-4 mt-sm-0 d-sm-block d-flex flex-column">
                          <ul>
                            <li class="fw-semi-bold text-black">Copies Sold: 150 million</li>
                          </ul>
                ...
                <div class="accordion-item mb-5 border border-x-0 border-bottom-0 border-200">
                  ...
                  <div class="accordion-collapse collapse shadow-lg" id="collapse5" aria-labelledby="heading5" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      <div class="row justify-content-center-center">
                        <div class="col-12 col-sm-2"><img class="img-fluid d-block mx-auto mx-sm-0" src="assets/img/gallery/alice.jpg" width="130" alt="..." /></div>
                        <div class="col-12 col-sm-9 mt-4 mt-sm-0 d-sm-block d-flex flex-column">
                          <ul>
                            <li class="fw-semi-bold text-black">Copies Sold: 150 million</li>
                          </ul>
      ...
      <section class="py-6">
        <div class="bg-holder" style="background-image:url(sevi/public/assets/img/illustrations/cta-bg.png);background-position:right bottom;background-size:contain;">
        </div>
        <!--/.bg-holder-->

        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-5 col-lg-7 order-md-1 text-end"><img class="img-fluid mb-4 mb-md-0" src="sevi/public/assets/img/illustrations/cta.png" width="670" alt="" /></div>
            <div class="col-md-7 col-lg-5 text-center text-md-start">
              <h1 class="fw-semi-bold text-warning lh-base">Create <span class="text-1100">your own <br/>mobile library</span></h1>
              <p class="my-4 lh-lg"> Create your own library on your phone easily with Sevi mobile app. Get it free on Google Play Store for android and Download on the App Store for iOS for free.</p>
              <div class="d-flex justify-content-center d-md-inline-block"><a class="pe-2 pe-sm-3 pe-md-4" href="!#"><img src="sevi/public/assets/img/gallery/google-play.png" width="160" alt="" /></a><a href="!#"><img src="sevi/public/assets/img/gallery/app-store.png" width="160" alt="" /></a></div>
            </div>
          </div>
        </div>
      </section>
      <section class="py-0">
        ...
        <div class="container">
          <div class="row justify-content-between pb-5 pt-8">
            <div class="col-12 col-lg-auto mb-5 mb-lg-0"><a class="d-flex align-items-center fw-semi-bold fs-3" href="#"> <img class="me-3" src="assets/img/gallery/logo.png" alt="" />
                <div class="text-primary font-base">Sevi</div>
              </a></div>
            ...
            <div class="col-auto mb-3">
              ...
              <ul class="list-unstyled mb-md-4 mb-lg-0">
                ...
                <li class="mb-3"><a class="text-700 text-decoration-none" href="#!">Report a Problem</a></li>
                <li class="mb-3"><a class="text-700 text-decoration-none" href="#!">Suggesting Edits</a></li>
